...
const questionsArr = [
  ...
  {
    question:"هل يمكنني التسجيل كمستخدم في تطبيق خرده؟",
    answer:"نعم، يمكن لأي شخص تسجيل حساب في تطبيق خرده ليتمكن من بيع الخردة الخاصه به."
  },
  {
    question:"ما هي الميزات الرئيسية لتطبيق خرده؟",
    answer:"ما هي الميزات الرئيسية لتطبيق خرده؟"
  },
  {
    question:"ما هو هدف تطبيق خرده؟",
    answer:"يهدف تطبيق خرده إلى تسهيل عملية شراء الخردة بكافة انواعها القديمة بطريقة مرنة وفعالة."
  },
  {
